...
echo -e "${GREEN}Setting up app icon for QuitAll...${NC}"

# Paths
SOURCE_ICON="public/asset/icon.png"
APPICONSET="QuitAll/Assets.xcassets/AppIcon.appiconset"
...
echo -e "  2. Or open in Xcode: ${GREEN}open QuitAll.xcodeproj${NC}"
echo -e ""
